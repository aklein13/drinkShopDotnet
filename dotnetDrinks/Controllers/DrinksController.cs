...
namespace dotnetDrinks.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Amount,Price")] Drink drink)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Amount,Price")] Drink drink)
        {
            if (id != drink.Id)
            {
                return NotFound();
